...
RUN echo 'Installing MSA plugin' && \
    ...
    wget http://138.68.65.103:8081/artifactory/intellij_plugins_snapshot_local/de/monticore/lang/montisecarc/IntelliJ_Language_Plugin/0.8.2.SNAPSHOT/IntelliJ_Language_Plugin-0.8.2.SNAPSHOT.zip -O msa.zip -q && \
    unzip -q msa.zip && \
    rm msa.zip
